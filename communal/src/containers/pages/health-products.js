    ...
    render () {
        return (
            <div className="row mx-3">
                <div>
                    1. multiple checkbox and Nested modal callback (Yes)  2. high Order Component show other component  3. realtime search, reselect and redux-form  4. translation  5. test  6.  recursion (Yes) 7. route to dispath and fetch data.
                </div>
                ...
                <div className="col-12 col-sm-6 col-lg-3">
                    <ul className="list-group">
                        ...
                        <li className="list-group-item bg-secondary text-white">
                            (recursion) keep Obj value includes 'Hit' and obj has 2nd deep (children) -- Check in Console.
                        </li>
                        <li className="list-group-item">
                            result (in console 221): {this.recursionObjIncludesHitN2ndDeepthChildren()}
                        </li>
                    </ul>
                </div>
                <div className="col-12 col-sm-6 col-lg-3">
...
export default connect(mapStateToProps, {grabMissChildren, getObjForPropValue})(HealthProductsCompo);